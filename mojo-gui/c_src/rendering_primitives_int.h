...
// Text input handling
const char* get_input_text(void);                            // Returns current input buffer
int has_new_input(void);                                     // 1=new input available, 0=none
int clear_input_buffer(void);                               // Clear input buffer
int get_input_length(void);                                 // Returns length of input text
