...
# Dock positions
comptime DOCK_LEFT = 0
comptime DOCK_RIGHT = 1
comptime DOCK_TOP = 2
comptime DOCK_BOTTOM = 3
comptime DOCK_CENTER = 4
comptime DOCK_FLOAT = 5

# Auto-hide states
comptime AUTOHIDE_NONE = 0
comptime AUTOHIDE_PINNED = 1
comptime AUTOHIDE_HIDDEN = 2
comptime AUTOHIDE_SHOWING = 3
